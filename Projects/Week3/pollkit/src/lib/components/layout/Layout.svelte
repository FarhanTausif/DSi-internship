    ...
    <header class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-30">
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-8">
                    ...
                    <nav class="hidden md:flex gap-1">
                        <a
                            href="#/"
                            class="px-4 py-2 rounded-lg transition-colors {isActive('/') || isActive('')
            ...
            <nav class="md:hidden flex gap-1 mt-4">
                <a
                    href="#/"
                    class="flex-1 px-4 py-2 rounded-lg text-center transition-colors {isActive('/') || isActive('')
                        ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 font-medium'
                        : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'}"
                >
                    Polls
                ...
                <a
                    href="#/dashboard"
                    class="flex-1 px-4 py-2 rounded-lg text-center transition-colors {isActive('/dashboard')
                        ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 font-medium'
                        : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'}"
                >
                    Dashboard
